...
namespace StoreManagement_Project.Controllers
{
    public class WarehouseController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("WarehouseId,Name,Address")] Warehouse warehouse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("WarehouseId,Name,Address")] Warehouse warehouse)
        {

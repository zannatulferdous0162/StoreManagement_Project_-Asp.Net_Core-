...
namespace StoreManagement_Project.Controllers
{
    public class ZoneController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("ZoneId,ZoneName,Remarks,WarehouseId")] Zone zone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("ZoneId,ZoneName,Remarks,WarehouseId")] Zone zone)
        {
            if (id != zone.ZoneId)
            {
                return NotFound();

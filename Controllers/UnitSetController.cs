...
namespace StoreManagement_Project.Controllers
{
    public class UnitSetController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("UnitSetId,NameOfUnitSet,Description,Remarks")] UnitSet unitSet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("UnitSetId,NameOfUnitSet,Description,Remarks")] UnitSet unitSet)
        {

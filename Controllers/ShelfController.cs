...
namespace StoreManagement_Project.Controllers
{
    public class ShelfController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("ShelfId,ShelfName,Remarks,WarehouseId")] Shelf shelf)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("ShelfId,ShelfName,Remarks,WarehouseId")] Shelf shelf)
        {
            if (id != shelf.ShelfId)
            {
                return NotFound();

...
namespace StoreManagement_Project.Controllers
{
    public class CurrencyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CurrencyId,NameOfCurrency,SymbolOfCurrency,ExchangeRate,IsBaseCurrency,Description,Remarks")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CurrencyId,NameOfCurrency,SymbolOfCurrency,ExchangeRate,IsBaseCurrency,Description,Remarks")] Currency currency)
        {

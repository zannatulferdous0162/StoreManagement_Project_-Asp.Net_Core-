...
namespace StoreManagement_Project.Controllers
{
    public class PackSizeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("PackSizeId,Size")] PackSize packSize)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("PackSizeId,Size")] PackSize packSize)
        {

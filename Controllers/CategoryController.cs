...
namespace StoreManagement_Project.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("CategoryId,CategoryName")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("CategoryId,CategoryName")] Category category)
        {

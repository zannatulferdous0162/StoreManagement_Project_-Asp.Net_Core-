...
namespace StoreManagement_Project.Controllers
{
    public class RackController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("RackId,RackName,Remarks,WarehouseId")] Rack rack)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("RackId,RackName,Remarks,WarehouseId")] Rack rack)
        {
            if (id != rack.RackId)
            {
                return NotFound();

...
namespace StoreManagement_Project.Controllers
{
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("BrandId,BrandName")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("BrandId,BrandName")] Brand brand)
        {
            if (id != brand.BrandId)
            {
                return NotFound();

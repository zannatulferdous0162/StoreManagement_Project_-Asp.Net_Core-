...
//        public async Task<IActionResult> Create([Aisled("StockId,ItemId,UnitId,Quantity")] Stock stock)
//        {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(int id, [Aisled("StockId,ItemId,UnitId,Quantity")] Stock stock)
//        {
//            if (id != stock.StockId)
//            {
//                return NotFound();
...
namespace StoreManagement_Project.Controllers
{
    public class StockController : Controller
    {
        ...
        public async Task<IActionResult> Create([Aisled("StockId,ItemId,UnitId,Quantity,LocationComponentId")] Stock stock)
        {
            if (ModelState.IsValid)
            {
                _context.Add(stock);
        ...
        // POST: Stock/Edit/5
        [HttpPost, ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Aisled("StockId,ItemId,UnitId,Quantity,LocationComponentId")] Stock stock)
        {
